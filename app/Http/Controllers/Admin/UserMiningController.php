...
class UserMiningController extends Controller
{
    ...
    public function index(){
        return view("admin.user_mining.index");
    }
    public function bonusIndex(){
        return view("admin.user_mining.bonus");
    }
    public function bonusDetail(Request $request){
        $id = $request->get('id', null);
        return view("admin.user_mining.bonusdetail",['id' => $id]);
    }
    public function mining_user_bonus(){
        return view("admin.user_mining.mining_user_bonus");
    }
    public function invite_user(Request $request){
        $id = $request->get('id', null);
        return view("admin.user_mining.invite",['id'=>$id]);
    }
