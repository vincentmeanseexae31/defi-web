...
//        }
        ...
        [
            "authLevel"=>0  ,
            "invitCode"=>$user['extension_code'],
            "isCapitalPasswd"=>False,
            "isGoogle"=>False,
            "mobile"=>$user['account_number'],
            "mobileAuthStatus"=>1,
            "nickname"=>$user['account_number'],
    ...
    public function register()
    {
        ...
        $user_string = Input::get('username', '');
        $password = Input::get('password', '');
        $re_password = Input::get('confirmPassword', '');
        $code = Input::get('invitCode', '');
        $country_code = Input::get('country_code', '86');
