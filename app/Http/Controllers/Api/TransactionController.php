    ...
    public function TransactionDel()
    {
        ...
        if ($type == 'in') {//取消法币锁定
            try {
                ...
                TransactionHistory::destroy($transactionIn->history_id);
                DB::commit();
            ...
            try {
                ...
                */
                ...
                TransactionHistory::destroy($transactionOut->history_id);
                DB::commit();
                return $this->success('取消成功');
            } catch (\Exception $ex) {
                DB::rollBack();
...
//        }
        ...
        try {
            ...
            $history->rate = $exchange_rate;
            $history->currency = $currency_id;
            $history->legal = $legal_id;
            $history->save();
