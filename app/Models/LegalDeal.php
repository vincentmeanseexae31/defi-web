...
class LegalDeal extends Model
{
    ...
    public function getPayWaysArrAttribute()
    {
        return LegalDealSend::find($this->attributes['legal_deal_send_id'])->pay_ways_arr;
    }

    public function getPayWaysNameAttribute()
    {
        return LegalDealSend::find($this->attributes['legal_deal_send_id'])->pay_ways_name;
    }
