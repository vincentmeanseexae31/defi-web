...
class MiningReturnsBonus extends Model
{
    protected $table = 'mining_returns_bonus';
    ...
    public static function AddBonus($user_id,$rate_num,$num,$rate,$from_user_id,$is_futou,$type,$up_down,$user_mining_id){
